def seed_consumables(db):
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/medium_health_potion.png", heal_amount=50, max_stack=1, price=45,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/greater_health_potion.png", heal_amount=120, max_stack=1, price=120,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/ultimate_health_potion.png", heal_amount=250, max_stack=1, price=300,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_speed.png", heal_amount=0, max_stack=1, price=80,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_slow.png", heal_amount=0, max_stack=1, price=60,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_poison.png", heal_amount=-10, max_stack=1, price=40,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_burning.png", heal_amount=-15, max_stack=1, price=55,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_dizziness.png", heal_amount=0, max_stack=1, price=30,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/elixir_of_life.png", heal_amount=999, max_stack=1, price=2000,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_strength.png", heal_amount=0, max_stack=1, price=110,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_haste.png", heal_amount=0, max_stack=1, price=130,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_shield.png", heal_amount=0, max_stack=1, price=100,
    ...
    db.add_consumable(
        ...
        image_path="assets/items/consumables/potion/potion_of_lethargy.png", heal_amount=0, max_stack=1, price=70,
