...
class MainMenu(Menu):
    ...
    def __init__(self, app: "App"):
        ...
        self.buttons = [
            ...
            Button(load_rect, _("LOAD"), cfg.button_color_LOAD,
                   cfg.button_hover_color_LOAD, cfg.button_font,
                   cfg.text_color, cfg.corner_radius, on_click=self.open_load_menu, shape=shield),
            Button(achievements_rect, _("ACHIEVEMENTS"), cfg.button_color_ACHIEVEMENTS,
                   cfg.button_hover_color_ACHIEVEMENTS, cfg.button_font,
